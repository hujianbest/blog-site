...
public class TagController {
    ...
    @Operation(summary = "Get articles by tag name")
    public ApiResponse<List<ArticleResponse>> getArticlesByTagName(@PathVariable String name) {
        List<ArticleResponse> response = tagService.getArticlesByTagName(name);
        return ApiResponse.success(response);
    }
